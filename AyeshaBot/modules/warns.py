...
import telegram
from AyeshaBot import WHITELIST_USERS, dispatcher
from AyeshaBot.modules.disable import DisableAbleCommandHandler
from AyeshaBot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from AyeshaBot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from AyeshaBot.modules.helper_funcs.string_handling import split_quotes
from AyeshaBot.modules.log_channel import loggable
from AyeshaBot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # AyeshaBot's sticker
        keyboard = None
        log_reason = (
