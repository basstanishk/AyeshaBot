...
import AyeshaBot.modules.sql.feds_sql as sql
...
from AyeshaBot.modules.helper_funcs.alternate import send_message
...
from AyeshaBot.modules.helper_funcs.string_handling import markdown_parser
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if fban:
        fed_name = info["fname"]
        # https://t.me/AyeshaBotSupport/41606 // https://t.me/AyeshaBotSupport/41619
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "AyeshaBot_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="AyeshaBot_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "AyeshaBot_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="AyeshaBot_fbanned_users.csv",
