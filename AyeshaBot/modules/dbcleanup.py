...
import AyeshaBot.modules.sql.global_bans_sql as gban_sql
import AyeshaBot.modules.sql.users_sql as user_sql
from AyeshaBot import DEV_USERS, OWNER_ID, dispatcher
