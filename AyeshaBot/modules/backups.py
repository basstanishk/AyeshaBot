...
import AyeshaBot.modules.sql.notes_sql as sql
from AyeshaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from AyeshaBot.__main__ import DATA_IMPORT
from AyeshaBot.modules.helper_funcs.chat_status import user_admin
from AyeshaBot.modules.helper_funcs.alternate import typing_action

# from AyeshaBot.modules.rules import get_rules
import AyeshaBot.modules.sql.rules_sql as rulessql

# from AyeshaBot.modules.sql import warns_sql as warnssql
import AyeshaBot.modules.sql.blacklist_sql as blacklistsql
from AyeshaBot.modules.sql import disable_sql as disabledsql

# from AyeshaBot.modules.sql import cust_filters_sql as filtersql
# import AyeshaBot.modules.sql.welcome_sql as welcsql
import AyeshaBot.modules.sql.locks_sql as locksql
from AyeshaBot.modules.connection import connected
...
def export_data(update: Update, context: CallbackContext):
    ...
    with open("AyeshaBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AyeshaBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `AyeshaBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("AyeshaBot{}.backup".format(chat_id))  # Cleaning file
