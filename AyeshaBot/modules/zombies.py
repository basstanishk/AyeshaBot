...
from AyeshaBot import telethn as AyeshaBotTelethonClient
from AyeshaBot.modules.sql.clear_cmd_sql import get_clearcmd
from AyeshaBot.modules.helper_funcs.telethn.chatstatus import user_is_admin
from AyeshaBot.modules.helper_funcs.misc import delete


@AyeshaBotTelethonClient.on(events.NewMessage(pattern=f"^[!/]zombies ?(.*)"))
