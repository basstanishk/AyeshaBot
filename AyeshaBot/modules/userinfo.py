...
from AyeshaBot.__main__ import STATS, GDPR, TOKEN, USER_INFO
import AyeshaBot.modules.sql.userinfo_sql as sql
from AyeshaBot.modules.disable import DisableAbleCommandHandler
from AyeshaBot.modules.sql.global_bans_sql import is_user_gbanned
from AyeshaBot.modules.sql.afk_sql import is_afk, check_afk_status
from AyeshaBot.modules.sql.users_sql import get_user_num_chats
from AyeshaBot.modules.sql.clear_cmd_sql import get_clearcmd
from AyeshaBot.modules.helper_funcs.chat_status import sudo_plus
from AyeshaBot.modules.helper_funcs.extraction import extract_user
from AyeshaBot.modules.helper_funcs.misc import delete
from AyeshaBot import telethn as AyeshaBotTelethonClient, SUDO_USERS, SUPPORT_USERS
...
def gdpr(update: Update, context: CallbackContext):
    ...
    update.effective_message.reply_text("Your personal data has been deleted.\n\nNote that this will not unban "
                                        "you from any chats, as that is telegram data, not AyeshaBot data. "
